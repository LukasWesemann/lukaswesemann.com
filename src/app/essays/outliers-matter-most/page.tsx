  ...
  return (
    ...
    >
      <p className="text-gray-700 font-serif leading-relaxed text-xl">
        Many important objectives in life are achieved by repeatedly sampling from a partly unknown probability distribution over possible outcomes. We want to find an apartment, so we go to many different inspections. We do our research and develop some feeling for which ones are promising and which ones aren't, but the distribution evolvoes over time and the uncertainty is large. So we try repeatedly until we find an apartment that we actually like. The same goes for finding a co-founder or a great deal for a second hand car and so on.
      </p>
